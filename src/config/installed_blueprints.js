export const installed_blueprints = [
  //@BlueprintInsertion
{ name: 'Add-Item24053', human_name: 'Add-item', access_route: 'Add-Item24053'},
{ name: 'EmailAuth24047', human_name: 'Email Auth', access_route: 'EmailAuth24047', icon: 'envelope-o'},
